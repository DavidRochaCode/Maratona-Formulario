...
const matricular = async (
  ...
  try {
    ...
    const curso = await axios.post(`${PATH_URL}/course/create`, {
...
const CursoForm = () => {
  ...
  const [terminadoInscricao] = useState(true);
  const cursos = [
  ...
  return (
    <div>
      {terminadoInscricao ? (
        <div>
          <h1 style={{color:"#0ec0c1"}}>A inscrição dos cursos foram finalizadas.</h1>
          <br />
        ...
        <div className="review_form_groupe">
          <p>
            Caso você tenha interesse em participar da maratona, por favor,
            prossiga clicando no botão de avançar.
          </p>
        </div>
      </div>
